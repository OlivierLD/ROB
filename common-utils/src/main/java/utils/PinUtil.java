...
public class PinUtil {
    ...
    public enum RaspiPin { // substitute for com.pi4j.io.gpio.RaspiPin...
        GPIO_00,
        GPIO_01,
        GPIO_02,
        GPIO_03,
    ...
    public enum GPIOPin {
        ...
        private final RaspiPin pin;

        GPIOPin(String name, int pinNumber, int gpio, int wiring, RaspiPin pin) {
            this.pinName = name;
        ...
        public RaspiPin pin() { return this.pin; }
    }

    public static RaspiPin getPinByPhysicalNumber(int n) {
        RaspiPin pin = null;
    ...
    public static int getPhysicalByWiringPiNumber(RaspiPin wPi) {
        int physical = 0;
        for (GPIOPin gpioPin : GPIOPin.values()) {
    ...
    public static RaspiPin getPinByWiringPiNumber(int n) {
        RaspiPin pin = null;
        for (GPIOPin gpioPin : GPIOPin.values()) {
    ...
    public static int getWiringPiNumber(RaspiPin p) {
        int wpi = -1;
        for (GPIOPin gpioPin : GPIOPin.values()) {
     ...
     * @return wPi Pin
     */
    public static RaspiPin getPinByGPIONumber(int n) {
        RaspiPin pin = null;
        for (GPIOPin gpioPin : GPIOPin.values()) {
            if (gpioPin.gpio() == n) {
                pin = gpioPin.pin();
    ...
    public static GPIOPin findByPin(RaspiPin pin) {
        GPIOPin gpio = null;
        for (GPIOPin gpioPin : GPIOPin.values()) {
