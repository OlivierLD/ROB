...
public class EclipseFinder {
    ...
    private final static SimpleDateFormat FRANCE_FMT = new SimpleDateFormat("dd-MMM-yyyy HH:mm:ss z");
    ...
    static {
        ...
        FRANCE_FMT.setTimeZone(TimeZone.getTimeZone("Europe/Paris"));
    ...
    // Belz
    private final static double CURRENT_LATITUDE = 47.677667d;
    private final static double CURRENT_LONGITUDE = -3.135667d;
    ...
    public static void main(String... args) {
        ...
        for (int h = 17; h < 20; h++) {
            for (int m = 0; m < 60; m++) {
                ...
                // System.out.printf("With DeltaT: %f\n", deltaT);
                ...
                if (deltaH < 0.05 || deltaZ < 0.2) { // then it is a n eclipse/conjunction
                    ...
                    System.out.println(FRANCE_FMT.format(cal.getTime()) + " => " + UTC_FMT.format(utc.getTime()));
