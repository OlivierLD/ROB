...
public class PositionInputPanel extends JPanel {
    ...
    private final JFormattedTextField LDeg = new JFormattedTextField(new DecimalFormat("#0"));
    private final JLabel jLabel4 = new JLabel();
    private final JFormattedTextField LMin = new JFormattedTextField(new DecimalFormat("00.00"));
    private final JComboBox<String> LSign = new JComboBox<>();
    private final JComboBox<String> GSign = new JComboBox<>();
    private final JFormattedTextField GMin = new JFormattedTextField(new DecimalFormat("00.00"));
    private final JFormattedTextField GDeg = new JFormattedTextField(new DecimalFormat("##0"));
    private final JLabel jLabel5 = new JLabel();
    private final JLabel jLabel6 = new JLabel();
    private final JFormattedTextField headingTextField = new JFormattedTextField(new DecimalFormat("##0"));
    ...
    private void jbInit() {
        ...
        LSign.setMinimumSize(new Dimension(45, 20));
        LSign.addItem("N");
        LSign.addItem("S");

        GSign.setPreferredSize(new Dimension(45, 20));
        GSign.setMinimumSize(new Dimension(45, 20));
        GSign.addItem("E");
        GSign.addItem("W");
...
//  g = GeomUtil.sexToDec(d, m);
    ...
    public int getHeading() {
        int heading = 0;
        try {
            heading = Integer.parseInt(headingTextField.getText());
        } catch (Exception ex) {
            ex.printStackTrace();
        }
        return heading;
