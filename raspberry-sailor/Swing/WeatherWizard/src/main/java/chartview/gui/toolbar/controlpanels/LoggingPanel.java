...
public class LoggingPanel
    ...
    private final JTextPane loggingTextZone = new JTextPane();

    private final LoggingPanelPopup rootPopup = new LoggingPanelPopup(loggingTextZone);
    ...
    private final StyledDocument doc = (StyledDocument) loggingTextZone.getDocument();
    ...
    private void jbInit() {
        ...
        loggingTextZone.setFont(new Font("Dialog", Font.PLAIN, 9));
