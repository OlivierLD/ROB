...
public class XSLUtil {
    ...
    public static double decimalPartInMinutes(double d) {
    ...
    public static String formatI3(double d) {
    ...
    public static String initAllCap(String s) {
        String str = "";
        try {
            str = s.toLowerCase();
            char[] ca = str.toCharArray();
    ...
    public static String sexToDec(String deg, String min, String sgn) {
