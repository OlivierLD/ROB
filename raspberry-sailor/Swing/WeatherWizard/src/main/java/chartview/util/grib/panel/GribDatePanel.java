...
public class GribDatePanel
    ...
    private final JTabbedPane dateTabbedPane = new JTabbedPane();
    private final JPanel topPanel = new JPanel();
    private final GridBagLayout gridBagLayout1 = new GridBagLayout();
    private final JLabel widthLabel = new JLabel();
    private final JLabel widthValueLabel = new JLabel();
    private final JLabel heightLabel = new JLabel();
    private final JLabel heightValueLabel = new JLabel();
    private final JLabel stepXLabel = new JLabel();
    private final JLabel stepXValueLabel = new JLabel();
    private final JLabel stepYLabel = new JLabel();
    private final JLabel stepYValueLabel = new JLabel();
    ...
    private final JLabel topValueLabel = new JLabel();
    private final JLabel leftValueLabel = new JLabel();
    private final JLabel bottomValueLabel = new JLabel();
    private final JLabel rightValueLabel = new JLabel();
