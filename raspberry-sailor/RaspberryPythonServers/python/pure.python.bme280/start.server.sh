...
#
nohup python3 -u REST_and_WEB_BME280_server.py --address:${I2C_ADDR} --verbose:${VERBOSE} --machine-name:${IP_ADDR} --store-restore:${STORE_RESTORE} --log-db:${LOG_DB} > bmp.log 2>&1 &
