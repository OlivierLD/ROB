...
public class TidePublisher {
    ...
    public static String publish(
        ...
        try {
            ...
            String cmd = // "." + File.separator + "xsl" + File.separator + (scriptToRun == null ? TIDE_TABLE : scriptToRun) + " " + radical;
                    SCRIPT_PATH + File.separator + (scriptToRun == null ? TIDE_TABLE : scriptToRun) + " " + radical  /*+ ".xml" <- YES, NO extension*/;
            if (lang != null) {
     ...
     * With special parameters (hard-coded)
     *
    ...
    public static void main(String... args) {
        ...
        System.out.printf("Publishing tides fot Station [%s], for year %d\n", station, year);
        ...
        try {
            ...
            // Highlight days when High Tide between 10:00 and 14:00
            sPrm.setTideType(TideForOneMonth.HIGH_TIDE);
            sPrm.setFromHour(10);
            sPrm.setToHour(14);

            System.setProperty("pdf.path", ".");
            System.setProperty("tide.calc.verbose", "false");
            ...
            String f = publish(tideStation,
                    ...
                    "FR",
                    "A4");
            System.out.printf("%s generated, in %s\n", f, System.getProperty("user.dir") + File.pathSeparator + PDF_PATH);
