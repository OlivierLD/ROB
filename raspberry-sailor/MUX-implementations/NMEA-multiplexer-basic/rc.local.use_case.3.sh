...
/home/pi/nmea-dist/python/scripts/start.EINK2-13.REST.server.sh --interactive:false  --machine-name:localhost --port:8080 --verbose:false --data:NAV,POS,SOG,COG --screen-saver:on --screen-saver-option:sleep --screen-saver-after:60 > /home/pi/nmea-dist/eink2-13.python.log 2>&1
sleep 10
# Start the MUX
