...
VERBOSE=false
#
/home/pi/nmea-dist/python/scripts/start.BME280.TCP.server.sh --interactive:false  --machine-name:${IP_ADDR} --port:8001 --verbose:${VERBOSE} --address:0x76 > /home/pi/nmea-dist/bme280.python.log 2>&1
sleep 10
# Start the MUX
