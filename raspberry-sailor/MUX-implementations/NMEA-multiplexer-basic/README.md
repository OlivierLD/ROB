...
This module does _**NOT**_ extend any Java class of the NMEA-multiplexer, and as you can see, there is just _**NO**_ extra Java code in this module. There is not even a `src` directory in this module (if there is one, it's empty).

This project contains a `to.prod.sh` script, that will suggest several ways to package - for deployment - the NMEA Multiplexer.
