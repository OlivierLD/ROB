...
class SightReductionUtil {
    ...
    private static string $fmt = "%1\$.3f";
...
//  System.out.println("Azimuth : " + GeomUtil.decToSex(Z));
	 ...
	 * Corrections
	 */
	private float $horizonDip = 0.0;
	private float $refraction = 0.0;
	private float $pa = 0.0;

	public static int $UPPER_LIMB = 0;
	public static int $LOWER_LIMB = 1;
	public static int $NEAR_LIMB = 2;
	public static int $FAR_LIMB = 3;
	public static int $NO_LIMB = -1; // Stars & Planets
