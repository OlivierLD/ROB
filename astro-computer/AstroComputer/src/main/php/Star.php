...
class Star {
    ...
    public string $starName = "", $constellationPlace = "";
    public float $ra, $dec, $deltaRa, $deltaDec, $par;
    
    private static int $STAR_NAME = 0;
    private static int $STAR_CONST = 1;
    private static int $STAR_RA = 2;
    private static int $STAR_DEC = 3;
    private static int $STAR_DELTA_RA = 4;
    private static int $STAR_DELTA_D = 5;
    private static int $STAR_PAR = 6;

    private static array $CATALOG = [ // could also be an array like array("nane" => "Aldebaran", "const" => ...)
        //       Name      Constellation pos     RA        Dec            deltaRA  deltaD  par
        array("Acamar", "theta Eridani", 2.9710266670, -40.3047138890, -0.3910, 1.9400, 0.0280),
        array("Achenar", "alfa Eridani", 1.6285700000, -57.2367166670, 1.1730, -3.4700, 0.0230),
        array("Acrux", "alpha Crux", 12.4432975000, -63.0990500000, -0.5240, -1.2100, 0.0000),
